...
public class ForeignCurrency extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		double exchangAmount = won / currencyRate[currencyIndex];
		String data = String.format("%,d", won) + " 원 ==> ";
		data += String.format("%.2f", exchangAmount) + " " + FOREIGN_CURRENCY[currencyIndex]; 
		System.out.println();
		...
		out.print("	<br>");
		out.print("	<button onclick=\"location.href='/ch06/foreignCurrency.html'\">재실행</button>");
		out.print("</body>");
		out.print("</html>");
	}
